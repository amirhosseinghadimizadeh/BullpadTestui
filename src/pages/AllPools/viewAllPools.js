...
const ViewAllPools = ({ darkMode, WalletConnect, connect, library, account, active, landingContainerWidth, navJustify }) => {
  const notify = () => {
    ...
    <>
      <div className="relative bg-darkMode-600 overflow-hidden">
        <div className="container mx-auto">
          <NavBar WalletConnect={WalletConnect} connect={connect} account={account} library={library} darkMode={darkMode} navigation={navigation} />
        </div>
        {/*pools header*/}
        <div className="scene relative">
          ...
          <header className="relative container mx-auto py-24 text-center">
            ...
            <Typing
              speed={1}
              hideCursor="true"
              className="text-white text-center lg:text-center font-semibold text-5xl"
            >
              Decentralized{" "}
