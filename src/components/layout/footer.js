        ...
        <div className="flex flex-col-reverse items-center space-y-reverse space-y-7 md:items-baseline md:grid md:grid-cols-3 mt-12">
          ...
          <div className="flex justify-center space-x-10">
            ...
            <a href="https://twitter.com/BullLaunchPad" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-twitter w-5 h-5 cursor-pointer"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="#a1add1"
                fill="none"
            ...
            <a href="https://t.me/BullLaunchPad" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-brand-facebook w-5 h-5 cursor-pointer"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
                stroke="#a1add1"
                fill="none"
