...
const NavBar = ({ darkMode, navigation, WalletConnect, account, connect, library,deactivate }) => {
  ...
  return (
    <>
      <ModalBlackBackground
        className={`${isOpen || isShow ? "inline" : "hidden"}`}
      />
      {/* opean wallet modal */}
            ...
            >
              <div className="inline-block border divide-y-2 divide-gray-200 border-gray-700 w-full py-6 max-w-sm my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="pt-3 px-6">
                  <div
                    onClick={connect}
                    className="flex justify-between hover:opacity-70 items-center bg-gray-100 px-4 py-2 rounded-lg font-bold mt-2 cursor-pointer"
                  >
